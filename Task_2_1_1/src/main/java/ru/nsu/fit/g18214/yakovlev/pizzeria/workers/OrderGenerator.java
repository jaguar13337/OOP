...
/**
 * Default orderGenerator realisation. Works until not interrupted
 */
public class OrderGenerator extends Person {
  ...
  public OrderGenerator(BlockingQueue<Order> orders, int period, Journal journal) {
    this.orders = orders;
    this.period = period;
