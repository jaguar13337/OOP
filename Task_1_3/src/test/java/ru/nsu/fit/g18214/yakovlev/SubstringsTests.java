...
public class SubstringsTests {
    ...
    private void appendFile(String str, File f) throws IOException {
    ...
    public void test1() throws IOException {
        ...
        String find = "mila";
        File f = createFile(text);
        int[] out = {5};
        Assert.assertArrayEquals(out, FindSubstrings.findSubstrings(f.getAbsolutePath(), find));
    }
    @Test
    public void test2() throws IOException {
        String text = "mama mila ramu, papa mil mashinu";
        String find = "mil";
        File f = createFile(text);
        int[] out = {5, 21};
        Assert.assertArrayEquals(out,FindSubstrings.findSubstrings(f.getAbsolutePath(), find));
    ...
    public void test6()  throws IOException {
        String text = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab";
        String find = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaac";
        int[] out = {};
        File f = createFile(text);
        Assert.assertArrayEquals(out,FindSubstrings.findSubstrings(f.getAbsolutePath(), find));
    }
